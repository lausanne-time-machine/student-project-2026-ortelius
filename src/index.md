...
<div style="position: relative; text-align: center; margin-bottom: 30px;">
  <img src="/images/title.jpg" alt="Fond historique" style="
    width: 100%; 
    height: 325px; /* Augmenté pour voir plus de l'image */
    object-fit: cover; 
    border-radius: 12px; 
  ...
  ">
    <h1 style="color: white; margin-bottom: 10px; margin-top: 0;">Évolution des plans d'eau lausannois : comment l'urbanisation a transformé les rivières et les rives du lac</h1>
    <h2 style="color: #f0f0f0; font-weight: normal; margin: 0;">Projet - HUM-454 Histoire urbaine digitale</h2>
  </div>
</div>
